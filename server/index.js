...
app.post('/api/chat', express.json(), async (req, res) => {
  ...
  if (!process.env.GROQ_API_KEY || process.env.GROQ_API_KEY === 'votre_cle_groq_ici') {
    return res.json({ 
      choices: [{ 
        message: { 
          content: "🤖 Mode démo. Pour l'IA complète, configurez votre clé API Groq dans les variables d'environnement sur Render." 
        } 
      }] 
    });
  }
